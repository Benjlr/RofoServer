...
namespace RofoServer.Core.Logic
{
    ...
    public class PasswordHasher
    {
        ...
        public static bool CheckPassword(string hashedPword, string pword) {
            return VerifyHashedPasswordV3(Convert.FromBase64String(hashedPword), pword, out var iters);
        }
